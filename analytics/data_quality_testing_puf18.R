...
#### Export to CSV ####
write.csv(pred_sum_testing_puf18,"pred_sum_testing_puf18.csv", row.names = FALSE)
write.csv(outcome_sum_testing_puf18,"outcome_sum_testing_puf18.csv", row.names = FALSE)
