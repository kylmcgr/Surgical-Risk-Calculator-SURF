# imports 2016 NSQIP data, separates into predictors and outcomes, recodes variables
# output of two elements, pred containing predictors and outcomes containing outcomes
# is.na for dealing with NA
# NA values for day variables are coded as -99
...
datatrain <- read.csv('acs_nsqip_puf16.txt', sep="\t", header = TRUE, stringsAsFactors = FALSE)
...
pred_puf16 <- transmute(datatrain,
...
outcome_puf16 <- transmute(datatrain,
