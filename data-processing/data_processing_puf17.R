# imports 2017 NSQIP data, separates into predictors and outcomes, recodes variables
...
# t_dat18 <- read.csv('acs_nsqip_puf18.txt', sep="\t", header = TRUE, stringsAsFactors = FALSE)
...
pred_puf17 <- transmute(datatrain,
...
outcome_puf17 <- transmute(datatrain,
