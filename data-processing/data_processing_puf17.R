...
# The output of this file is preimpute_pred_puf17 (a data table of predictors)
# and preimpute_outcomes_puf17 (a data table of outcomes).
...
preimpute_pred_puf17 <- transmute(datatrain_puf17,
...
preimpute_outcomes_puf17 <- transmute(datatrain_puf17,
...
#### Export R Objects ####
save(preimpute_pred_puf17, file = paste0("./data/", "preimpute_pred_puf17.Rda"))
save(preimpute_outcomes_puf17, file = paste0("./data/", "preimpute_outcomes_puf17.Rda"))