...
grouped_outcomes_puf17 <- transmute(outcomes_puf17,
                            ...
                            y_discharge = if_else(still_in_hosp_y == 0 | dicharge_year > 0, 1, 0),
                            
                            # Dead
                            # y_dead = if_else(death_year > 0 | days_death >= 0, 1, 0),
                            y_dead = if_else(death_year > 0, 1, 0),
                            
                            # Unplanned Reoperation
                            # y_reop = if_else(return_OR_y == 1 | reop1_y == 1 | days_reop1 >= 0 | reop2_y == 1 | days_reop2 >= 0 | reop3plus_y == 1, 1, 0),
                            y_reop = if_else(return_OR_y == 1 | reop1_y == 1 | reop2_y == 1 | reop3plus_y == 1, 1, 0),
                            ...
                            #                       days_readmit5 >= 0, 1, 0),
                            y_readmit = if_else(readmit1_y == 1 | unplan_readmit1_y == 1 | readmit2_y == 1 | unplan_readmit2_y == 1 | 
                                                  readmit3_y == 1 | unplan_readmit3_y == 1 | readmit4_y == 1 | 
                                                  unplan_readmit4_y == 1 | readmit5_y == 1 | unplan_readmit5_y == 1, 1, 0),
...
# Export R Object
save(grouped_outcomes_puf17, file = paste0("./data/", "grouped_outcomes_puf17.Rda"))
